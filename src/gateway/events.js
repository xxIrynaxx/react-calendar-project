const events = [
  ...
  },
  {
    ...
    title: 'Meet friend',
    description: 'at the cafe',
    dateFrom: new Date(2020, 9, 25, 10, 30),
    dateTo: new Date(2020, 9, 25, 11, 0),
  },
  {
    id: 6,
    title: 'Meet friend',
    description: 'at the cafe',
    dateFrom: new Date(2020, 3, 25, 10, 30),
    dateTo: new Date(2020, 3, 25, 11, 0),
  },
  {
    id: 7,
    title: 'Meet friend',
    description: 'at the cafe',
    dateFrom: new Date(2020, 5, 25, 10, 30),
    dateTo: new Date(2020, 5, 25, 11, 0),
  },
];
